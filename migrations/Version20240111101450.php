 ...
 */
final class Version20240111101450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , deposit_amount DOUBLE PRECISION NOT NULL, max_capacity INTEGER NOT NULL, propulsion_type VARCHAR(255) NOT NULL, size VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, CONSTRAINT FK_D86E834A7E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
