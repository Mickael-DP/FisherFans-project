 ...
 */
final class Version20231207133410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE boat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, manufacturing_year INTEGER NOT NULL, photo_url VARCHAR(255) NOT NULL, required_license_type VARCHAR(255) NOT NULL, boat_type VARCHAR(255) NOT NULL, equipment CLOB NOT NULL --(DC2Type:array)
        , deposit_amount DOUBLE PRECISION NOT NULL, max_capacity INTEGER NOT NULL, propulsion_type VARCHAR(255) NOT NULL, size VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TABLE fishing_log (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fish_name VARCHAR(255) NOT NULL, photo_url VARCHAR(255) NOT NULL, comment VARCHAR(255) DEFAULT NULL, size_cm DOUBLE PRECISION NOT NULL, weight_kg DOUBLE PRECISION NOT NULL, fishing_location VARCHAR(255) NOT NULL, fishing_date DATETIME NOT NULL, fish_released VARCHAR(255) NOT NULL, owner VARCHAR(255) NOT NULL)');
